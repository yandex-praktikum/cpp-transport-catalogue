...
void SecondLayer(const TransportCatalogue& catalogue, const json::Dict& dict,  svg::Document& doc, const SphereProjector& projector, const std::set<std::string_view>& buses);
